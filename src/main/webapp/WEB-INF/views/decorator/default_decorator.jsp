				...
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					<ul class="nav navbar-nav navbar-right">
						<c:if test="${ empty login }">
							<!-- 로그인이 되어 있지 않을 때 시작 -->
					    	<li><a href="/member/writeForm.do"><span class="glyphicon glyphicon-user"></span> 회원가입</a></li>
							<li><a href="/member/loginForm.do"><span class="glyphicon glyphicon-log-in"></span> 로그인</a></li>
							<!-- 로그인이 되어 있지 않을 때 끝 -->
						</c:if>
						<c:if test="${ ! empty login }">
							<!-- 로그인이 되어 때 시작 -->
					    	<li><a href="/member/view.do"><span class="glyphicon glyphicon-user"></span> ${login.name }</a></li>
